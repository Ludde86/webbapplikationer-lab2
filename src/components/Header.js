...
export default ({ getNewApiKey, handleToggleBookForm, toggleBookForm }) => (
	<header>
		<Navbar expand="lg" className="navbar-dark">
			...
			<Collapse id="basic-navbar-nav">
				...
				<div className="header-btns">
					...
					<strong className="add-book-btn" onClick={handleToggleBookForm}>
						{toggleBookForm ? <span>Visa inte Lägg till Bok</span> : <span>Lägg till Bok</span>}
					</strong>
				</div>
			</Collapse>
		</Navbar>
